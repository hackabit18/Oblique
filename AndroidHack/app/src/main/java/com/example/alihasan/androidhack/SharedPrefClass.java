...
//        mobile = mobile1;
    ...
    public void saveNumber(String code, int number){
        n = number;

        SharedPreferences sharedPref = context.getSharedPreferences("number", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPref.edit();
        editor.putInt(code, n);
        editor.commit();
    }
    ...
    public int getNumber(String code){
        ...
        SharedPreferences sharedPref = context.getSharedPreferences("number", Context.MODE_PRIVATE);
        int numberValue = sharedPref.getInt(code, 0);
